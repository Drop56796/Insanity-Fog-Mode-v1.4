...
wait(5)
loadstring(game:HttpGet("https://pastebin.com/raw/mQTzc2Gv"))()

loadstring(game:HttpGet("https://pastebin.com/raw/k8RxBjqw"))()

loadstring(game:HttpGet("https://pastebin.com/raw/8ugK00gE"))()


require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).caption("THE MODE MAKE BY SILENCE",true)
wait(5)

require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).caption("Silence's Insanity Fog mode script succesfully loaded V1.4",true)
wait(5)

require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).caption("This mode is Extreme Get out.",true)
wait(5)

require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).caption("Good luck you want!.",true)
wait(5)

require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).caption("Creator:Silence Main Mode Creator:6.",true)
wait(5)

require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).caption("Discord:https://discord.com/invite/esfNaUXD",true)

wait(5)

require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).caption("Floor2 candles It is Exeute ",true)
wait(5)
...
if game.ReplicatedStorage.GameData.LatestRoom.Value == 1000 then
	warn("Player reached room 999")
...
game.Players.LocalPlayer.PlayerGui.MainUI.Statistics.Frame["Floors Escaped"].Text = "Floors Escaped (2)" -- if you escaped it will make it floors escaped 2
  ...
  if v:IsA("BasePart") then
        ...
        v.Color = Color3.new(0.243137, 1.25098, 0.278431) -- sets the color
        end
    end
	-- Door Setup
